...
public class ClienteView extends JWindow {
	...
	public void GuiView() {
		...
		btnCadastrarCliente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (cadastroClienteView == null) {
					...
					contentPane.add(cadastroClienteView);
					cadastroClienteView.setLocation(200, 150);
				}
		...
		try {
			img = ImageIO.read(new File("/Users/MaryBeds/git/SysArmasHeuber/src/main/java/imagens/cadastroIcon.png"));
		...
		try {
			imgEditar = ImageIO.read(new File("/Users/MaryBeds/git/SysArmasHeuber/src/main/java/imagens/editarIcon.png"));
		...
		try {
			imgDeletar = ImageIO.read(new File("/Users/MaryBeds/git/SysArmasHeuber/src/main/java/imagens/deletarIcon.png"));
		...
		try {
			imgIr = ImageIO.read(new File("/Users/MaryBeds/git/SysArmasHeuber/src/main/java/imagens/btnIr.png"));
